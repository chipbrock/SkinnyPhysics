...
date: 2026-02-08 
title: "Skinny Motion, Speed, and Acceleration"
subtitle: "Learning motion by Example"
...
Skinny Physics is meant to be a lightweight presentation of physics that might help you appreciate some of the posts in **QS&BB.** This chapter shows some bare bones (skinny, after all!) **facts about motion, speed, and acceleration**.
...
**A fact: Units are a part of the world!**
We need to convert one unit to another all the time. But I won't make a big deal of it and expect you to go to Mr Google when you need to do a conversion. For example, type into the search bar "100 mph in km/h" and you'll get an interactive tool with that answer (160 km/h) and the ability to change the question. 

### Example: unit conversion
::: {.callout-note title="Example" icon="false"}
✏️  Here's how to do it so you can appreciate what's behind the scenes:  [**How to do unit Conversions**](./examples/_output/unit_conversion.html)
:::

## Gentle Examples of Velocity and Acceleration 🐇
...
### Example: average speed {#sec-averagespeed}
...
Famously, Galileo Galilei determined that any object near the earth would fall at a constant acceleration and you can read the story at [Galileo](https://qsbb2020jupyter.netlify.app/motion/j-050_motion_g_galileo2_s7). What he found was that the speed of a falling object would increase linearly with the time of it's fall.
...
### Example: deriving the equations of motion three ways

::: {.callout-note title="Example" icon="false"}
✏️  A bit of algebra is required to derive the complete quartet of equations for motion with a constant acceleration. I do that for you in:
[**equations of motion**](./examples/_output/Motion_equations.html)
:::
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1190824142?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="kinematics equations"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
<br><br> So collectively, here are our definitions for motion:
$$\begin{align}
...
::: {.callout-note title="Example" icon="false"}
✏️ We'll need apples a lot!  [**Apple falling in a race with being flicked from a table**](./examples/_output/apple_motion.html)
:::

### Example: dropping from the Leaning Tower?

::: {.callout-note title="Example" icon="false"}
✏️  (Under Construction 🚧 👷‍♂️ placeholder for an example 🔎 Pisa)
TEXT [**title**](LINK.html)
:::

### Examples: a more realistic trip

::: {.callout-note title="Example" icon="false"}
 ✏️ Let’s go “up north” (which in Michigan is a thing), but we’ll do it at a constant speed: 
[**up_north.html**](./examples/_output/up_north.html)
:::

::: {.callout-note title="Example" icon="false"}
 ✏️ But that doesn’t make sense. How about a more sensible trip with starts and stops...and state police?
[**up_north_realistic.html**](./examples/_output/up_north_realistic.html)
:::

### Example: an Airbus 330-300 takeoff
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1200838817?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="SFO_28L"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
<br><br>

### Stop an aircraft carrier
::: {.callout-note title="Example" icon="false"}
