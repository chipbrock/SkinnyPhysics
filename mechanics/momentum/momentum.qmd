...
Skinny Physics is meant to be a lightweight (skinny, after all) presentation of some physics that might help you appreciate some of the posts in **QS&BB.** Maybe you've had a course in your past and maybe not, so this chapter has some bare bones (skinny, after all) **facts about impulse, momentum, and force**.

So: three sections: (1) Some ideas you might not have had in a previous course. ("different way") (2) A listing of some impulse, momentum, and force facts. And, (3) a bit of gentle background behind those facts. If you'd like more, then visit the [full textbook](https://qstbb.pa.msu.edu/storage/ISP220_fall2020/QS&BB2020/intro.html) presentation.
...
[momentum of an aircraft carrier](./examples/Nimitz_1_E2.html)
:::
...
One quick change of @eq-momentum:
...
F &= ma \tag{b}
\end{align}
$$ {#eq-newtons2} A couple of these are suitable for a T-shirt: @eq-newtons2 (a) is formally "Newton's Second law of Motion" in its most general physics-major form. @eq-newtons2 (b) is the T-shirt version for motion in which the mass of an object undergoing a push doesn't change.
